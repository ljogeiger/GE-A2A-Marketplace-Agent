...
async def create_root_agent():
    ...
    agent_card_base_url = "https://remote-time-agent-m74hb36eya-uc.a.run.app/a2a/remote_time_agent/"  # TRAILING SLASH
    agent_card_url = f"{agent_card_base_url}.well-known/agent.json"
